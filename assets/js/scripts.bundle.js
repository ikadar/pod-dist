...
var KTMenu = function(element, options) {
    ...
    var _update = function() {
        ...
        var items = the.element.querySelectorAll('.menu__item[data-kt-menu-trigger]');
    ...
    var _isItemParentShown = function(item) {
        ...
        return KTUtil.parents(item, '.menu__item.show').length > 0;
    ...
    var _hasItemSub = function(item) {
        ...
        return (KTUtil.hasClass(item, 'menu__item') && item.hasAttribute('data-kt-menu-trigger'));
    ...
    var _getItemLinkElement = function(item) {
        ...
        return KTUtil.child(item, '.menu__link');
    ...
    var _getItemElement = function(element) {
        ...
        if ( (item = element.closest('.menu__item')) ) {
    ...
    var _getItemParentElement = function(item) {  
        ...
        if ( sub && (parentItem = sub.closest('.menu__item[data-kt-menu-trigger]')) ) {
    ...
    var _getItemChildElement = function(item) {
        ...
        if ( selector !== null ) {
            ...
            //element = selector.querySelector('.show.menu__item[data-kt-menu-trigger]');

            element = selector.querySelector('.menu__item[data-kt-menu-trigger]');
    ...
    var _setActiveLink = function(link) {
        ...
        var activeLinks = [].slice.call(the.element.querySelectorAll('.menu__link.active'));

        var activeParentItems = [].slice.call(the.element.querySelectorAll('.menu__item.here, .menu__item.show'));
    ...
    var _getLinkByAttribute = function(value, name = "href") {
        ...
        var link = the.element.querySelector('.menu__link[' + name + '="' + value + '"]');
...
KTMenu.getInstance = function(element) {
    ...
    if ( KTUtil.hasClass(element, 'menu__link') ) {
...
KTMenu.initHandlers = function() {
    ...
    KTUtil.on(document.body,  '.menu__item[data-kt-menu-trigger] > .menu__link, [data-kt-menu-trigger]:not(.menu__item):not([data-kt-menu-trigger="auto"])', 'click', function(e) {
    ...
    KTUtil.on(document.body,  '.menu__item:not([data-kt-menu-trigger]) > .menu__link', 'click', function(e) {
